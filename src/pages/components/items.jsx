...
const Items = () => {
  ...
  return (
    <div>
      ...
      <div className="ml-20 mr-20 mb-36">

        <div className="flex font-sans">
          <div className="flex-none w-48 relative">
            <Image src="/items-farmer.jpg" alt="" height={100} width={100} className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
            <img />
          </div>
          <form className="flex-auto p-6">
            <div className="flex flex-wrap">
              <h1 className="flex-auto text-lg font-semibold text-slate-900">
                Buy items from My network
              </h1>
